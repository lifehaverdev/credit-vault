...
// The address of the proxied Foundation contract
address constant FOUNDATION_PROXY = 0x011528b1d5822B3269d919e38872cC33bdec6d17;
...
contract ReadCustody is Script {
    ...
    function run() external view {
        Foundation foundation = Foundation(payable(FOUNDATION_PROXY));
        ...
        bytes32 custodyValue = foundation.custody(custodyKey);
        ...
        console.log("Proxy Address:", FOUNDATION_PROXY);
        console.log("===================================");
